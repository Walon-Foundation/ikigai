    ...
    <section className="relative overflow-hidden bg-primary pb-24 pt-40">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        <motion.h1
          ...
          className="font-display mb-6 text-5xl font-black leading-[1.05] tracking-tight text-primary-foreground sm:text-6xl md:text-7xl"
        >
        ...
        <motion.p
          ...
          className="mx-auto mb-10 max-w-2xl text-xl leading-relaxed text-primary-muted"
        >
