...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="absolute -right-48 -top-48 h-[700px] w-[700px] rounded-full bg-primary-muted/20" />
      <div className="absolute right-1/4 top-1/2 h-[400px] w-[400px] -translate-y-1/2 rounded-full bg-accent-pale/40" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 pb-28 pt-24">
        <div className="max-w-3xl">
          ...
          <p className="mb-10 max-w-xl text-xl leading-relaxed text-muted-foreground">
            Ikigai connects ambitious young people in Freetown and Western Rural
            Area with verified mentors, growth tools, and a community that
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/sign-up"
              className="inline-flex items-center gap-2 rounded-full bg-primary px-8 py-4 text-base font-semibold text-primary-foreground transition-colors hover:bg-primary-light"
            >
              Start Your Journey
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-3">
          {stats.map((stat) => (
            <div key={stat.label} className="text-center">
              ...
              <div className="mt-2 text-sm font-medium text-primary-muted">
                {stat.label}
              </div>
            </div>
          ))}
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {pillars.map((pillar) => (
            ...
            >
              <div className="mb-5 inline-flex rounded-xl bg-primary-muted/30 p-3">
